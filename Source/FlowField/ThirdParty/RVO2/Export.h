...
/* NOLINTNEXTLINE(readability-macro-parentheses) */
#ifndef RVO_DEPRECATED_MACRO
#  define RVO_DEPRECATED_MACRO /* no replacement */
#endif

#ifndef RVO_NO_DEPRECATED_MACRO
#  define RVO_NO_DEPRECATED_MACRO /* no replacement */
#endif
